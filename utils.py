...
class SummarizeDataset():
    def __init__(self, examples, tokenizer, args, stage, only_src=False):
    ...
    def __getitem__(self, index):
        ...
        input_features = convert_one_examples_to_features_with_sl(
            example=example,
